...
Las tareas correspondientes a la entrega TB2 se completaron en el repositorio de GitHub de la organización del equipo, disponible en el enlace de repositorio del informe.
...
![Impact Mapping](assets/img/develop/commits_tb2.png)
https://github.com/UPC-PRE-202502-1ASI0657-2520-6336/Report/graphs/contributors

Networks Insights report:

![Impact Mapping](assets/img/develop/network_tb2.png)
...
<table style="width:100%; border-collapse:collapse; table-layout:fixed; font-size:14px;">
  ...
  <thead>
    ...
    <tr>
      ...
      <th style="border:1px solid #444; padding:8px;">
        <div style="display:flex; flex-direction:column; align-items:center; gap:6px;">
          <img src="assets/img/chapter-2/competidores/aboga_logo.png" alt="Aboga.pe logo" style="height:40px; object-fit:contain; display:block;">
          <span>Aboga.pe</span>
        </div>
      </th>
      <th style="border:1px solid #444; padding:8px;">
        <div style="display:flex; flex-direction:column; align-items:center; gap:6px;">
          <img src="assets/img/chapter-2/competidores/legal-partners-peru_logo.png" alt="Legal Partners Peru logo" style="height:40px; object-fit:contain; display:block;">
...
![Impact Mapping](assets/img/develop/Impact-map-abogado.png)


**_Segmento Objetivo 2: Jean Patrick Sanchez Rios - Cliente_**
![Impact Mapping](assets/img/develop/Impact-Mapping-Segmento-2.png)
...
Gestión y actualización de casos 

Como abogado, quiero gestionar mis casos activos en la plataforma para mantener un registro organizado y actualizado de mi trabajo, lo que me permitirá priorizar mis tareas eficientemente. 
...
Publicar casos de éxito en perfil 

Como abogado, quiero publicar casos de éxito en mi perfil para demostrar mi experiencia y atraer a más clientes interesados en mis servicios. 
...
Configurar y validar disponibilidad 

Como abogado, quiero configurar mi disponibilidad en la plataforma para que los clientes puedan agendar citas conmigo en los horarios correctos, para maximizar el uso eficiente de mi tiempo. 
...
Visualización de Progreso de Caso 

W13 

Mostrar progreso y hitos del caso 

Como cliente, quiero ver el progreso actual de mi caso en tiempo real para estar al tanto de los avances y próximos pasos, para poder tomar decisiones informadas. 
...
Envío de notificaciones de cambios 

Como cliente, quiero recibir notificaciones cuando haya actualizaciones importantes en mi caso para estar al tanto de cualquier cambio o avance y tomar medidas rápidas si es necesario. 
...
Mostrar servicios destacados en landing 
...
Atajos y accesos rápidos en landing 
...
Información Clara y Concisa sobre el Servicio 

W19 

Contenido claro y descriptivo en landing 
...
Implementar diseño responsivo en landing 
...
Chat en Tiempo Real con Abogado 

W23 

Implementar chat en tiempo real 

Como cliente, quiero tener la opción de chatear en tiempo real con un abogado para obtener respuestas rápidas a mis preguntas antes de agendar una consulta formal. 
...
Revisión del Progreso del Caso 

W24 

Panel de progreso por caso 

Como cliente, quiero poder revisar el progreso de mi caso a través de la plataforma para estar al tanto de los avances realizados por el abogado. 
...
Evaluación y Calificación del Abogado 

W25 

Flujos de evaluación y recordatorios 

Como cliente, quiero poder evaluar y calificar al abogado después de la consulta para contribuir a la retroalimentación y calidad del servicio. 
...
Registro y alertas de actividad 

Como administrador, quiero monitorizar la actividad de los usuarios en la plataforma para detectar comportamientos inusuales o potenciales amenazas de seguridad. 
...
Configurar respaldos y pruebas de recuperación 

Como administrador, quiero asegurar que la plataforma realice respaldos automáticos de todos los datos importantes y cuente con un sistema de recuperación. 
...
Implementar responsividad en toda la app 

Como desarrollador, quiero implementar un diseño responsivo en la plataforma para asegurar que los usuarios puedan acceder y utilizar la plataforma desde cualquier dispositivo con facilidad. 
...
Optimizar interacciones y rendimiento UI 

Como desarrollador, quiero optimizar la interacción del usuario con la plataforma para que las acciones sean intuitivas y rápidas, mejorando la experiencia general. 
...
Implementar i18n y persistencia de idioma 

Como desarrollador, quiero implementar la internacionalización en la plataforma para que sea accesible en múltiples idiomas. 
...
Soporte total de navegación por teclado 

Como desarrollador, quiero asegurar que todas las funciones de la plataforma sean accesibles mediante el teclado para que los usuarios que no pueden usar un mouse puedan navegar fácilmente. 
...
**Links** 
<br>
Web desplegada: https://frontendgit-09482557-4f090.web.app/ 
